...
1 -- I want to find the means of pain-free range of motion per condition.
...
I should note that I do not quite understand why DirectionofRotation is a between subjects variable; it seems like it should be another within variabe. However, doing this just yields 46 degrees of freedom (But note that even with DirectionofRotation as a between-subj variable, the df is wrong -- it is 92 instead of 94 as reported). 
...
# copilot: bonf
ttestbonf0.8v1 <- pairwise.t.test(d$Condition1_Gain0.8, d$Condition2_Gain1)
ttestbonf0.8v1.2 <- pairwise.t.test(d$Condition1_Gain0.8, d$Condition3_Gain1.2, p.adj = "bonf")
ttestbonf1.2v1 <- pairwise.t.test(d$Condition3_Gain1.2, d$Condition2_Gain1, p.adj = "bonf")
