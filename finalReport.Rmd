...
We create a repeated measures ANOVA using condition as a within subjects variable, and DirectionofRotation as a between subjects variable. This achieves nearly the desired effect size and degrees of freedom, and the correct p value.
...
aov_ez(data = d.tidy,
       id = "Participant",
       dv = "rangeofmotion",
       within = c("condition", "DirectionofRotation"),
