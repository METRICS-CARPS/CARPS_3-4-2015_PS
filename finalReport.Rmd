...
Interestingly it seems we can reproduce the effect sizes (but still not the p-values) when assuming independent samples, which is the wrong choice for this dataset (because responses came from the same, not different, participants):
