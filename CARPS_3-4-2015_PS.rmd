...
understatement.pvalue <- compareValues(reportedValue = .006, obtainedValue = .00205, isP=T)

overstatement.effectsize <- compareValues(reportedValue = .8, obtainedValue = 0.7959338, isP=T)

overstatement.pvalue <- compareValues(reportedValue = .001, obtainedValue = .0003054, isP=T)
